...
// Removed StellarWalletConnector import - using simple button instead
...
export function BridgeInterface({
	...
	const [selectedRoute, setSelectedRoute] = useState<"direct" | "multi-hop">(
		"direct"
	);
	...
	return (
		<div className="relative">
				...
				<CardContent className="p-0 overflow-visible">
					<div className="flex h-[600px] overflow-visible">
								...
								<div className="mt-4 space-y-2 text-xs">
									<div className="flex justify-between items-center">
										...
										>
											{stellarWallet.isConnected
												? `Connected (${
														stellarWallet.selectedWalletId ||
														"Unknown"
												  })`
												: "Disconnected"}
										</span>
									...
									{(stellarWallet.isConnected ||
										...
										<div className="text-center">
											<p className="text-xs text-muted-foreground">
												{stellarWallet.isConnected &&
												sepoliaWallet.isConnected
													? "Both wallets connected - Ready to bridge!"
													: stellarWallet.isConnected
													? "Stellar connected - Connect Sepolia to bridge"
													: "Sepolia connected - Connect Stellar to bridge"}
											</p>
										</div>
									)}
								</div>
						...
						<div
							...
							} bg-stellar/10 rounded-r-xl border-l border-white/10 flex flex-col h-full overflow-hidden transition-all duration-300 ease-in-out relative`}
						>
							<div
								className={`${
			...
			{/* Enhanced Route Information Panel - Pops from far right side */}
			<div className="hidden lg:block absolute left-full top-0 ml-4 z-30">
				{routeInfo?.isVisible && (
					<>
						...
						<EnhancedRouteInfoPanel
							simulation={simulation}
							routeComparison={routeComparison}
							isSimulating={isSimulating}
							onExecute={executeEnhancedBridge}
							isExecuting={isExecuting}
							fusionHealth={fusionHealth}
			...
			{routeInfo?.isVisible && (
				<div className="mt-4 lg:hidden">
					<Button
						variant="outline"
						onClick={() =>
							setShowMobileRouteInfo?.(!showMobileRouteInfo)
						}
